...
public class Pawn_MindState : IExposable
{
	...
	public void StartFleeingBecauseOfPawnAction(Thing instigator)
	{
		...
		{
			pawn.jobs.StartJob(JobMaker.MakeJob(JobDefOf.ExitMapFlying), JobCondition.InterruptForced, null, resumeCurJobAfterwards: false, cancelBusyStances: true, null, null, fromQueue: false, canReturnCurJobToPool: false, null);
			return;
		}
