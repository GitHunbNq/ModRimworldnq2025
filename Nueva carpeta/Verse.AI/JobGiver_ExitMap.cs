...
public abstract class JobGiver_ExitMap : ThinkNode_JobGiver
{
	...
	protected override Job TryGiveJob(Pawn pawn)
	{
		...
		if (flag)
		{
			using PawnPath path = pawn.Map.pathFinder.FindPathNow(pawn.Position, dest, TraverseParms.For(pawn, Danger.Deadly, TraverseMode.PassAllDestroyableThings), null);
			IntVec3 cellBefore;
