...
public class PathGrid : IDisposable
{
	...
	public void RecalculatePerceivedPathCostAt(IntVec3 c, ref bool haveNotified)
	{
		...
		{
			pathGrid[map.cellIndices.CellToIndex(c)] = CalculatedCostAt(c, perceivedStatic: true, IntVec3.Invalid, null);
		}
	}
	...
	private bool RecalcuateCellDirect(IntVec3 c)
	{
		...
		pathGrid[index] = CalculatedCostAt(c, perceivedStatic: true, IntVec3.Invalid, null);
