...
public class SketchResolver_MechhiveGuardOutpost : SketchResolver
{
	...
	protected override void ResolveInt(SketchResolveParams parms)
	{
		...
		foreach (IntVec3 edgeCell in cellRect.EdgeCells)
		{
			...
			{
				sketch.AddThing(ThingDefOf.Barricade, edgeCell, Rot4.North, ThingDefOf.Steel, 1, null, null);
			}
		}
		...
		sketch.AddThing(ThingDefOf.Turret_AutoMiniTurret, cellRect.CenterCell, Rot4.North, null, 1, null, null);
