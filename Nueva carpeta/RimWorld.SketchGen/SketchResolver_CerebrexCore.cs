...
public class SketchResolver_CerebrexCore : SketchResolver
{
	...
	protected override void ResolveInt(SketchResolveParams parms)
	{
		...
		sketch.AddThing(ThingDefOf.CerebrexCore, new IntVec3(0, 0, 0), Rot4.North, null, 1, null, null);
		for (int i = 0; i < 61; i++)
		{
			for (int j = 0; j < 61; j++)
			{
	...
	private static int GenerateBuilding(Sketch sketch, Rot4 dir)
	{
		...
		{
			sketch.AddThing(ThingDefOf.AncientFortifiedWall, new IntVec3(num - i, 0, num).RotatedBy(dir), Rot4.North, null, 1, null, null);
			sketch.AddThing(ThingDefOf.AncientFortifiedWall, new IntVec3(num, 0, num - i).RotatedBy(dir), Rot4.North, null, 1, null, null);
			if (i < 7)
			{
				sketch.AddThing(ThingDefOf.AncientFortifiedWall, new IntVec3(num - i, 0, 2).RotatedBy(dir), Rot4.North, null, 1, null, null);
				sketch.AddThing(ThingDefOf.AncientFortifiedWall, new IntVec3(2, 0, num - i).RotatedBy(dir), Rot4.North, null, 1, null, null);
			}
			if (i >= 6)
			{
				sketch.AddThing(ThingDefOf.AncientFortifiedWall, new IntVec3(num - i, 0, num - 7 + 1).RotatedBy(dir), Rot4.North, null, 1, null, null);
				sketch.AddThing(ThingDefOf.AncientFortifiedWall, new IntVec3(num - 7 + 1, 0, num - i).RotatedBy(dir), Rot4.North, null, 1, null, null);
			}
			for (int j = 1; j < 6; j++)
			{
		...
		for (int k = -2; k <= 2; k++)
		{
			sketch.AddThing(ThingDefOf.AncientFortifiedWall, new IntVec3(k, 0, num + 4).RotatedBy(dir), Rot4.North, null, 1, null, null);
		}
		return num;
	}
	...
	private static void AddBuildingPathway(Sketch sketch, Rot4 dir)
	{
		int num = Mathf.FloorToInt(30.5f);
		int num2 = 0;
		sketch.AddThing(ThingDefOf.AncientFortifiedWall, new IntVec3(num - 2, 0, num - 2).RotatedBy(dir), Rot4.North, null, 1, null, null);
		...
		for (int i = 0; i < num3; i++)
		{
			...
			sketch.AddThing(ThingDefOf.AncientFortifiedWall, new IntVec3(num - 3 - i, 0, num - 2).RotatedBy(dir), Rot4.North, null, 1, null, null);
			if (i != 0)
			{
				sketch.AddThing(ThingDefOf.AncientFortifiedWall, new IntVec3(num - 3 - i, 0, num - 4).RotatedBy(dir), Rot4.North, null, 1, null, null);
		...
		sketch.AddThing(ThingDefOf.AncientFortifiedWall, new IntVec3(num - 3 - num3 + 1, 0, num - 3).RotatedBy(dir), Rot4.North, null, 1, null, null);
		...
		for (int j = 0; j < num3; j++)
		{
			...
			sketch.AddThing(ThingDefOf.AncientFortifiedWall, new IntVec3(num - 2, 0, num - 3 - j).RotatedBy(dir), Rot4.North, null, 1, null, null);
			if (j != 0)
			{
				sketch.AddThing(ThingDefOf.AncientFortifiedWall, new IntVec3(num - 4, 0, num - 3 - j).RotatedBy(dir), Rot4.North, null, 1, null, null);
		...
		sketch.AddThing(ThingDefOf.AncientFortifiedWall, new IntVec3(num - 3, 0, num - 3 - num3 + 1).RotatedBy(dir), Rot4.North, null, 1, null, null);
	...
	private static void AddConnection(Sketch sketch, IntVec3 rootCell, Rot4 direction)
	{
		for (int i = 1; i < 4; i++)
		{
			...
			sketch.AddThing(ThingDefOf.AncientFortifiedWall, intVec + direction.Rotated(RotationDirection.Clockwise).AsIntVec3, Rot4.North, null, 1, null, null);
			sketch.AddThing(ThingDefOf.AncientFortifiedWall, intVec + direction.Rotated(RotationDirection.Counterclockwise).AsIntVec3, Rot4.North, null, 1, null, null);
		}
		sketch.AddThing(ThingDefOf.AncientBlastDoor, rootCell + direction.AsIntVec3 * 3, direction, null, 1, null, null);
	}
}
