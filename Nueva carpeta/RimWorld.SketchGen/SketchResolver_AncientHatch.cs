...
public class SketchResolver_AncientHatch : SketchResolver
{
	...
	protected override void ResolveInt(SketchResolveParams parms)
	{
		...
		{
			sketch.AddThing(ThingDefOf.AncientSecurityTurret, corner, Rot4.North, null, 1, null, null);
		}
		sketch.AddThing(ThingDefOf.AncientHatch, cellRect.CenterCell, Rot4.North, null, 1, null, null);
