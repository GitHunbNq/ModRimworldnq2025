...
public class PsychicRitualToil_TargetCleanup : PsychicRitualToil
{
	...
	public override void Start(PsychicRitual psychicRitual, PsychicRitualGraph parent)
	{
		...
		{
			target.HomeFaction.TryAffectGoodwillWith(Faction.OfPlayer, -25, canSendMessage: true, canSendHostilityLetter: true, HistoryEventDefOf.WasPsychicRitualTarget, null);
		}
