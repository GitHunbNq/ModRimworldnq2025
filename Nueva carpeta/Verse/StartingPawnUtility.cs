...
public static class StartingPawnUtility
{
	...
	public static void DrawPortraitArea(Rect rect, int pawnIndex, bool renderClothes, bool renderHeadgear)
	{
		...
		RenderTexture image = PortraitsCache.Get(pawn2, pawnPortraitSize, south, default(Vector3), 1f, supersample: true, compensateForUIScale: true, renderHeadgear2, renderClothes2, null, null, stylingStation: true, null);
