...
public class Command_SetPlantToGrow : Command
{
	...
	public override void ProcessInput(Event ev)
	{
		...
		for (int i = 0; i < tmpAvailablePlants.Count; i++)
		{
			...
			}, plantDef, null, forceBasicStyle: false, MenuOptionPriority.Default, null, null, 29f, (Rect rect) => Widgets.InfoCardButton(rect.x + 5f, rect.y + (rect.height - 24f) / 2f, plantDef), null, playSelectionSound: true, 0, null));
		}
		if (list.Any())
		{
