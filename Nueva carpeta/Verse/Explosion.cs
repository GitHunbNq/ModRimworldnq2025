...
public class Explosion : Thing
{
	...
	public override void ExposeData()
	{
		...
		Scribe_Values.Look(ref postExplosionGasType, "postExplosionGasType", null);
		...
		Scribe_Values.Look(ref needLOSToCell1, "needLOSToCell1", null);
		Scribe_Values.Look(ref needLOSToCell2, "needLOSToCell2", null);
		Scribe_Values.Look(ref affectedAngle, "affectedAngle", null);
