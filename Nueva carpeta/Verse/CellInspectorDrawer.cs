...
public static class CellInspectorDrawer
{
	...
	private static void DrawWorldInspector()
	{
		...
		{
			string info = (WorldPathGrid.CalculatedMovementDifficultyAt(mouseTileIndex, perceivedStatic: false, null) * Find.WorldGrid.GetRoadMovementDifficultyMultiplier(mouseTileIndex, PlanetTile.Invalid)).ToString("0.#");
