...
public struct ShotReport
{
	...
	public static ShotReport HitReportFor(Thing caster, Verb verb, LocalTargetInfo target)
	{
		...
		{
			result.factorFromShooterAndDist = HitFactorFromShooter(caster, result.distance, null);
		}
		else
		{
