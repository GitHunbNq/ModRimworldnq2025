...
public static class DebugAutotests
{
	...
	private static void TestForceDownedx100()
	{
		for (int i = 0; i < 100; i++)
		{
			...
			Pawn pawn = PawnGenerator.GeneratePawn(random, FactionUtility.DefaultFactionFrom(random.defaultFactionDef), null);
