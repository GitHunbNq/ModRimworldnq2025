...
public class WorldComponent_GravshipController : WorldComponent
{
	...
	public override void WorldComponentOnGUI()
	{
		...
		if (landingMap != null)
		{
			if (Widgets.ButtonText(rect2, "AbortLandGravship".Translate(), drawBackground: true, doMouseoverSound: true, active: true, null))
			{
		...
		if (Widgets.ButtonText(rect2, "DesignatorMoveGravship".Translate(), drawBackground: true, doMouseoverSound: true, active: true, null))
		{
			Find.DesignatorManager.Select(designator_MoveGravship);
		}
		TooltipHandler.TipRegion(rect2, "DesignatorMoveGravshipDesc".Translate());
		rect2.x += 210f;
		if (Widgets.ButtonText(rect2, "ConfirmLandGravship".Translate(), drawBackground: true, doMouseoverSound: true, active: true, null))
		{
