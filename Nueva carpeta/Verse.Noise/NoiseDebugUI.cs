...
public static class NoiseDebugUI
{
	...
	public static void NoiseDebugOnGUI()
	{
		...
		if (Widgets.ButtonText(new Rect(0f, 40f, 200f, 30f), "Clear noise renders", drawBackground: true, doMouseoverSound: true, active: true, null))
		{
			Clear();
		}
		if (Widgets.ButtonText(new Rect(200f, 40f, 200f, 30f), "Hide noise renders", drawBackground: true, doMouseoverSound: true, active: true, null))
		{
			DebugViewSettings.drawRecordedNoise = false;
		}
		if (WorldRendererUtility.WorldSelected)
		{
			if (planetNoises.Any() && Widgets.ButtonText(new Rect(400f, 40f, 200f, 30f), "Next planet noise", drawBackground: true, doMouseoverSound: true, active: true, null))
			{
