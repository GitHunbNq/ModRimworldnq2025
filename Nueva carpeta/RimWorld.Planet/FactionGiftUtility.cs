...
public static class FactionGiftUtility
{
	...
	public static void GiveGift(List<Tradeable> tradeables, Faction giveTo, GlobalTargetInfo lookTarget)
	{
		...
		Faction.OfPlayer.TryAffectGoodwillWith(giveTo, goodwillChange, canSendMessage: true, canSendHostilityLetter: true, HistoryEventDefOf.GaveGift, null);
	}
	...
	public static void GiveGift(List<ActiveTransporterInfo> pods, Settlement giveTo)
	{
		...
		Faction.OfPlayer.TryAffectGoodwillWith(giveTo.Faction, goodwillChange, canSendMessage: true, canSendHostilityLetter: true, HistoryEventDefOf.GaveGift, null);
	}
