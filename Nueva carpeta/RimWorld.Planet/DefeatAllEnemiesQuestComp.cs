...
public class DefeatAllEnemiesQuestComp : WorldObjectComp, IThingHolder
{
	...
	private void GiveRewardsAndSendLetter()
	{
		...
		Faction.OfPlayer.TryAffectGoodwillWith(requestingFaction, relationsImprovement, canSendMessage: false, canSendHostilityLetter: false, HistoryEventDefOf.QuestGoodwillReward, null);
