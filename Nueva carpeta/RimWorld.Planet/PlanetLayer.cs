...
{
	public delegate float CalculateAverageTileSize_000152FC_0024PostfixBurstDelegate(in NativeArray<int> tileIDToNeighbors_offsets, in NativeArray<PlanetTile> tileIDToNeighbors_values, in NativeArray<int> tileIDToVerts_offsets, in NativeArray<Vector3> verts);

	internal static class CalculateAverageTileSize_000152FC_0024BurstDirectCall
	{
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(CalculateAverageTileSize_000152FC_0024PostfixBurstDelegate).TypeHandle);
			}
			P_0 = Pointer;
		}
		...
		static CalculateAverageTileSize_000152FC_0024BurstDirectCall()
		{
			Constructor();
		}
	...
	public delegate float IntGetTileSize_000152FE_0024PostfixBurstDelegate(in NativeArray<int> tileIDToNeighbors_offsets, in NativeArray<PlanetTile> tileIDToNeighbors_values, in NativeArray<int> tileIDToVerts_offsets, in NativeArray<Vector3> verts, in PlanetTile tile);

	internal static class IntGetTileSize_000152FE_0024BurstDirectCall
	{
		private static IntPtr Pointer;
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(IntGetTileSize_000152FE_0024PostfixBurstDelegate).TypeHandle);
			}
			P_0 = Pointer;
		}
		...
		static IntGetTileSize_000152FE_0024BurstDirectCall()
		{
			Constructor();
		}
	...
	public delegate void IntGetTileCenter_00015301_0024PostfixBurstDelegate(in NativeArray<int> tileIDToVerts_offsets, in NativeArray<Vector3> verts, int tileID, out Vector3 center);

	internal static class IntGetTileCenter_00015301_0024BurstDirectCall
	{
		private static IntPtr Pointer;
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(IntGetTileCenter_00015301_0024PostfixBurstDelegate).TypeHandle);
			}
			P_0 = Pointer;
		}
		...
		static IntGetTileCenter_00015301_0024BurstDirectCall()
		{
			Constructor();
		}
	...
	{
		return CalculateAverageTileSize_000152FC_0024BurstDirectCall.Invoke(in tileIDToNeighbors_offsets, in tileIDToNeighbors_values, in tileIDToVerts_offsets, in verts);
	}
	...
	{
		return IntGetTileSize_000152FE_0024BurstDirectCall.Invoke(in tileIDToNeighbors_offsets, in tileIDToNeighbors_values, in tileIDToVerts_offsets, in verts, in tile);
	}
	...
	{
		IntGetTileCenter_00015301_0024BurstDirectCall.Invoke(in tileIDToVerts_offsets, in verts, tileID, out center);
	}
