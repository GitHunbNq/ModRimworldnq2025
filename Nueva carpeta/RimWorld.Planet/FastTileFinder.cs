...
public class FastTileFinder : IDisposable
{
	...
	{
		public delegate float SphericalDistance_00014E3B_0024PostfixBurstDelegate(in float3 a, in float3 b);

		internal static class SphericalDistance_00014E3B_0024BurstDirectCall
		{
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(SphericalDistance_00014E3B_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static SphericalDistance_00014E3B_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		{
			return SphericalDistance_00014E3B_0024BurstDirectCall.Invoke(in a, in b);
		}
	...
	public static void Initialize_0024ComputeQueryJob_SphericalDistance_00014E3B_0024BurstDirectCall()
	{
		ComputeQueryJob.SphericalDistance_00014E3B_0024BurstDirectCall.Initialize();
	}
}
