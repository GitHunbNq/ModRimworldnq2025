...
public static class WorldFactionsUIUtility
{
	...
	public static void DoWindowContents(Rect rect, List<FactionDef> factions, bool isDefaultFactionCounts)
	{
		...
		if (Widgets.ButtonText(rect5, "Add".Translate().CapitalizeFirst() + "...", drawBackground: true, doMouseoverSound: true, active: true, null) && TutorSystem.AllowAction("ConfiguringWorldFactions"))
		{
