...
public class QuestNode_Root_RefugeeDelayedReward : QuestNode
{
	protected override void RunInt()
	{
		...
		quest.Delay(num, delegate
		{
			...
			quest.DropPods(map.Parent, list, null, null, "[rewardLetterText]", null, true, useTradeDropSpot: true, joinPlayer: false, makePrisoners: false, null, null, QuestPart.SignalListenMode.OngoingOnly, null);
