...
public abstract class QuestNode_Root_Mission : QuestNode
{
	...
	protected override void RunInt()
	{
		...
		}, variants: null, addShuttleLootReward: false, addPossibleFutureReward: false, overridePopulationIntent: null);
		...
		quest4.AddShipJob_Arrive(transportShip, parent, null, null, ShipJobStartMode.Instant, ofEmpire);
		...
		quest.FactionGoodwillChange(asker.Faction, 0, inSignal4, canSendMessage: true, canSendHostilityLetter: true, getLookTargetFromSignal: true, HistoryEventDefOf.ShuttleDestroyed, QuestPart.SignalListenMode.OngoingOnly, ensureMakesHostile: true);
		...
		quest5.SignalPassActivable(action, null, text3, null, null, inSignalDisable);
