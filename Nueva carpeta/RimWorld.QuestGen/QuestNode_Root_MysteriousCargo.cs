...
public abstract class QuestNode_Root_MysteriousCargo : QuestNode
{
	...
	protected override void RunInt()
	{
		...
		quest.Delay(Mathf.RoundToInt(DelayHours.RandomInRange * 2500f), delegate
		{
			...
			Pawn asker2 = asker;
			quest2.GiveRewards(parms, null, null, null, null, null, null, null, null, addCampLootReward: false, asker2, addShuttleLootReward: false, addPossibleFutureReward: false, null);
