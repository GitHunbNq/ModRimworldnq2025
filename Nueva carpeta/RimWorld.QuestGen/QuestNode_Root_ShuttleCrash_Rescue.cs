...
public class QuestNode_Root_ShuttleCrash_Rescue : QuestNode
{
	...
	protected override void RunInt()
	{
		...
		string inSignal4 = QuestGenUtility.HardcodedSignalWithQuestID("rescueShuttle.LeftBehind");
		string inSignal5 = QuestGenUtility.HardcodedSignalWithQuestID("asker.Destroyed");
		string inSignal6 = QuestGenUtility.HardcodedSignalWithQuestID("civilian.Destroyed");
		string inSignal7 = QuestGenUtility.HardcodedSignalWithQuestID("map.MapRemoved");
		...
		quest.SignalPass(delegate
		{
			...
			Quest quest4 = quest;
			Pawn asker2 = asker;
			quest4.GiveRewards(parms, null, null, null, null, null, null, null, null, addCampLootReward: false, asker2, addShuttleLootReward: true, addPossibleFutureReward: false, null);
		...
		quest.Letter(LetterDefOf.NegativeEvent, inSignal5, null, Faction.OfEmpire, null, useColonistsFromCaravanArg: false, QuestPart.SignalListenMode.OngoingOnly, Gen.YieldSingle(asker), filterDeadPawnsFromLookTargets: false, "[askerDiedLetterText]", null, "[askerDiedLetterLabel]");
		quest.End(QuestEndOutcome.Fail, 0, null, inSignal5);
		quest.Letter(LetterDefOf.NegativeEvent, inSignal6, null, Faction.OfEmpire, null, useColonistsFromCaravanArg: false, QuestPart.SignalListenMode.OngoingOnly, civilians, filterDeadPawnsFromLookTargets: false, "[civilianDiedLetterText]", null, "[civilianDiedLetterLabel]");
		quest.End(QuestEndOutcome.Fail, 0, null, inSignal6);
		...
		quest.Letter(LetterDefOf.NegativeEvent, inSignal4, null, Faction.OfEmpire, null, useColonistsFromCaravanArg: false, QuestPart.SignalListenMode.OngoingOnly, Gen.YieldSingle(rescueShuttle), filterDeadPawnsFromLookTargets: false, "[shuttleLeftBehindLetterText]", null, "[shuttleLeftBehindLetterLabel]");
		...
		string inSignal8 = QuestGenUtility.HardcodedSignalWithQuestID("askerFaction.BecameHostileToPlayer");
		quest.End(QuestEndOutcome.Fail, 0, null, inSignal8, QuestPart.SignalListenMode.OngoingOnly, sendStandardLetter: true);
		quest.End(QuestEndOutcome.InvalidPreAcceptance, 0, null, inSignal8, QuestPart.SignalListenMode.NotYetAcceptedOnly);
		quest.Letter(LetterDefOf.NegativeEvent, inSignal7, null, Faction.OfEmpire, null, useColonistsFromCaravanArg: false, QuestPart.SignalListenMode.OngoingOnly, Gen.YieldSingle(asker), filterDeadPawnsFromLookTargets: false, "[mapRemovedLetterText]", null, "[mapRemovedLetterLabel]");
		quest.End(QuestEndOutcome.Fail, 0, null, inSignal7);
