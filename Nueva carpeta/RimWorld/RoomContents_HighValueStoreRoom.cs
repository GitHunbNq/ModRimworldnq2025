...
public class RoomContents_HighValueStoreRoom : RoomContentsWorker
{
	...
	public override void FillRoom(Map map, LayoutRoom room, Faction faction, float? threatPoints = null)
	{
		...
		RoomGenUtility.SpawnHermeticCrateInRoom(room, map, ThingSetMakerDefOf.MapGen_HighValueCrate, addRewards: true, null, null);
	...
	private static void SpawnShelves(Map map, LayoutRoom room)
	{
		...
		while (num2 > 0 && possibleSpots.Any())
		{
			...
			GenPlace.TryPlaceThing(thing, intVec, map, ThingPlaceMode.Near, null, null, null);
		}
