...
public class Page_ConfigureStartingPawns : Page
{
	...
	private void DrawPawnList(Rect rect)
	{
		...
		for (int i = 0; i < Find.GameInitData.startingAndOptionalPawns.Count; i++)
		{
			...
			GUI.DrawTexture(position2, PortraitsCache.Get(pawn, pawnSelectorPortraitSize, south, default(Vector3), 1f, supersample: true, compensateForUIScale: true, flag2, flag, null, null, stylingStation: false, null));
