...
public class Page_CreateWorldParams : Page
{
	...
	public override void DoWindowContents(Rect rect)
	{
		...
		if (!TutorSystem.TutorialMode)
		{
			...
			if (Widgets.ButtonText(new Rect(200f, num2, width, 30f), "Edit".Translate() + "...", drawBackground: true, doMouseoverSound: true, active: true, null))
			{
		...
		if (Widgets.ButtonText(rect11, "ResetAll".Translate(), drawBackground: true, doMouseoverSound: true, active: true, null))
		{
			Reset();
		}
		rect11.x = x + 8.5f;
		if (Widgets.ButtonText(rect11, "ResetFactions".Translate(), drawBackground: true, doMouseoverSound: true, active: true, null))
		{
			ResetFactionCounts();
			SoundDefOf.Tick_Tiny.PlayOneShotOnCamera();
		}
