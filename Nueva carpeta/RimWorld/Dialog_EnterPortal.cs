...
public class Dialog_EnterPortal : Window
{
	...
	private void DoBottomButtons(Rect rect)
	{
		...
		if (Widgets.ButtonText(new Rect(rect.width - BottomButtonSize.x, rect.height - 55f - 17f, BottomButtonSize.x, BottomButtonSize.y), "AcceptButton".Translate(), drawBackground: true, doMouseoverSound: true, active: true, null) && TryAccept())
		{
