...
public class Verb_SmokePop : Verb
{
	...
	public static void Pop(CompApparelReloadable comp)
	{
		if (comp != null && comp.CanBeUsed(out var _))
		{
			...
			GenExplosion.DoExplosion(wearer.Position, wearer.Map, statValue, DamageDefOf.Smoke, null, -1, -1f, null, null, null, null, null, 0f, 1, GasType.BlindSmoke, null, 255, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, null, null);
			comp.UsedOnce();
		}
	}
}
