...
public class Dialog_Trade : Window
{
	...
	public override void DoWindowContents(Rect inRect)
	{
		...
		if (Widgets.ButtonText(rect6, TradeSession.giftMode ? ("OfferGifts".Translate() + " (" + FactionGiftUtility.GetGoodwillChange(TradeSession.deal.AllTradeables, TradeSession.trader.Faction).ToStringWithSign() + ")") : "AcceptButton".Translate(), drawBackground: true, doMouseoverSound: true, active: true, null))
		{
		...
		if (Widgets.ButtonText(new Rect(rect6.x - 10f - OtherBottomButtonSize.x, rect6.y, OtherBottomButtonSize.x, OtherBottomButtonSize.y), "ResetButton".Translate(), drawBackground: true, doMouseoverSound: true, active: true, null))
		{
		...
		if (Widgets.ButtonText(new Rect(rect6.xMax + 10f, rect6.y, OtherBottomButtonSize.x, OtherBottomButtonSize.y), "CancelButton".Translate(), drawBackground: true, doMouseoverSound: true, active: true, null))
		{
			Close();
			Event.current.Use();
		}
