...
public class Page_SelectScenario : Page
{
	...
	private void DoScenarioListEntry(Rect rect, Scenario scen)
	{
		...
		if (scen.Category == ScenarioCategory.CustomLocal && widgetRow.ButtonIcon(TexButton.Delete, "Delete".Translate(), GenUI.SubtleMouseoverColor, null, null))
		{
		...
		if (scen.Category == ScenarioCategory.SteamWorkshop && widgetRow.ButtonIcon(TexButton.Delete, "Unsubscribe".Translate(), GenUI.SubtleMouseoverColor, null, null))
		{
		...
		{
			if (widgetRow.ButtonIcon(ContentSource.SteamWorkshop.GetIcon(), "WorkshopPage".Translate(), null, null, null))
			{
