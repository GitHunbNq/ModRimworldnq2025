...
public class Page_SelectStartingSite : Page
{
	...
	private void DoCustomBottomButtons()
	{
		...
		if ((Widgets.ButtonText(new Rect(num6, num7, Page.BottomButSize.x, Page.BottomButSize.y), "Back".Translate(), drawBackground: true, doMouseoverSound: true, active: true, null) || KeyBindingDefOf.Cancel.KeyDownEvent) && CanDoBack())
		{
			DoBack();
		}
		num6 += Page.BottomButSize.x + 10f;
		if (Widgets.ButtonText(new Rect(num6, num7, Page.BottomButSize.x, Page.BottomButSize.y), "SelectRandomSite".Translate(), drawBackground: true, doMouseoverSound: true, active: true, null))
		{
		...
		if (Widgets.ButtonText(new Rect(num6, num7, Page.BottomButSize.x, Page.BottomButSize.y), "WorldFactionsTab".Translate(), drawBackground: true, doMouseoverSound: true, active: true, null))
		{
			Find.WindowStack.Add(new Dialog_FactionDuringLanding());
		}
		num6 += Page.BottomButSize.x + 10f;
		if (Widgets.ButtonText(new Rect(num6, num7, Page.BottomButSize.x, Page.BottomButSize.y), "Next".Translate(), drawBackground: true, doMouseoverSound: true, active: true, null) && CanDoNext())
		{
			DoNext();
		}
		num6 += Page.BottomButSize.x + 10f;
