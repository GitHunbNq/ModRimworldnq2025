...
public class WeatherEvent_LightningStrike : WeatherEvent_LightningFlash
{
	...
	public static void DoStrike(IntVec3 strikeLoc, Map map, ref Mesh boltMesh)
	{
		...
		{
			GenExplosion.DoExplosion(strikeLoc, map, 1.9f, DamageDefOf.Flame, null, -1, -1f, null, null, null, null, null, 0f, 1, null, null, 255, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, null, null);
