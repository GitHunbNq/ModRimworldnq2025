...
public class Building_Battery : Building
{
	...
	protected override void Tick()
	{
		...
		if (ticksToExplode > 0)
		{
			...
			if (ticksToExplode == 0)
			{
				GenExplosion.DoExplosion(base.Spawned ? this.OccupiedRect().RandomCell : base.PositionHeld, radius: Rand.Range(0.5f, 1f) * 3f, map: base.MapHeld, damType: DamageDefOf.Flame, instigator: null, damAmount: -1, armorPenetration: -1f, explosionSound: null, weapon: null, projectile: null, intendedTarget: null, postExplosionSpawnThingDef: null, postExplosionSpawnChance: 0f, postExplosionSpawnThingCount: 1, postExplosionGasType: null, postExplosionGasRadiusOverride: null, postExplosionGasAmount: 255, applyDamageToExplosionCellsNeighbors: false, preExplosionSpawnThingDef: null, preExplosionSpawnChance: 0f, preExplosionSpawnThingCount: 1, chanceToStartFire: 0f, damageFalloff: false, direction: null, ignoredThings: null, affectedAngle: null);
