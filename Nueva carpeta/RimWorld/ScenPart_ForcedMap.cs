...
public class ScenPart_ForcedMap : ScenPart
{
	...
	public override void DoEditInterface(Listing_ScenEdit listing)
	{
		...
		if (Widgets.ButtonText(scenPartRect, mapGenerator.LabelCap, drawBackground: true, doMouseoverSound: true, active: true, null))
		{
		...
		if (!Widgets.ButtonText(scenPartRect, layerDef.LabelCap, drawBackground: true, doMouseoverSound: true, active: true, null))
		{
			return;
		}
