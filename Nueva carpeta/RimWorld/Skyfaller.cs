...
public class Skyfaller : ThingWithComps, IThingHolder, IRoofCollapseAlert
{
	...
	protected virtual void Impact()
	{
		...
		if (def.skyfaller.CausesExplosion)
		{
			...
			GenExplosion.DoExplosion(position, map, explosionRadius, explosionDamage, null, damAmount, -1f, null, null, null, null, null, 0f, 1, null, null, 255, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, ignoredThings, null);
		}
		SpawnThings();
		innerContainer.ClearAndDestroyContents();
		CellRect cellRect = this.OccupiedRect();
