...
public class CompAbilityEffect_Firefoampop : CompAbilityEffect
{
	...
	public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
	{
		...
		effecter.Cleanup();
		GenExplosion.DoExplosion(target.Cell, parent.pawn.MapHeld, Props.firefoamRadius, DamageDefOf.Extinguish, null, -1, -1f, SoundDefOf.Explosion_FirefoamPopper, null, null, null, ThingDefOf.Filth_FireFoam, 1f, 1, null, null, 255, applyDamageToExplosionCellsNeighbors: true, null, 0f, 1, 0f, damageFalloff: false, null, null, null);
	}
