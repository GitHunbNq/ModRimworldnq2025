...
public static class MapGenUtility
{
	...
	internal static class ComputeLargestRects_0000B6CA_0024BurstDirectCall
	{
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(ComputeLargestRects_0000B6CA_0024PostfixBurstDelegate).TypeHandle);
			}
			P_0 = Pointer;
		}
		...
		static ComputeLargestRects_0000B6CA_0024BurstDirectCall()
		{
			Constructor();
		}
	...
	public delegate void RectsComputeSpaces_0000B6CB_0024PostfixBurstDelegate(ref NativeArray<CellData> set, in NativeArray<float> elevation, in CellIndices indices, float minElevation, float maxElevation, int borderPadding);

	internal static class RectsComputeSpaces_0000B6CB_0024BurstDirectCall
	{
		private static IntPtr Pointer;
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(RectsComputeSpaces_0000B6CB_0024PostfixBurstDelegate).TypeHandle);
			}
			P_0 = Pointer;
		}
		...
		static RectsComputeSpaces_0000B6CB_0024BurstDirectCall()
		{
			Constructor();
		}
	...
	{
		ComputeLargestRects_0000B6CA_0024BurstDirectCall.Invoke(ref rects, ref set, in elevation, in indices, minWidth, minHeight, maxWidth, maxHeight, minElevation, maxElevation, mapBorderPadding);
	}
	...
	{
		RectsComputeSpaces_0000B6CB_0024BurstDirectCall.Invoke(ref set, in elevation, in indices, minElevation, maxElevation, borderPadding);
	}
	...
	public static bool IsGoodSpawnCell(ThingDef def, IntVec3 pos, Map map)
	{
		...
		if (!GenSpawn.CanSpawnAt(def, pos, map, null))
		{
			return false;
		}
		foreach (IntVec3 cell in cellRect.Cells)
