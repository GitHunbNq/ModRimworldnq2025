...
public class LordJob_StructureThreatCluster : LordJob
{
	...
	public override StateGraph CreateGraph()
	{
		...
		transition2.AddTrigger(new Trigger_PawnHarmed(1f, requireInstigatorWithFaction: false, Faction.OfPlayer, null, null));
		...
		transition3.AddTrigger(new Trigger_PawnHarmed(1f, requireInstigatorWithFaction: false, Faction.OfPlayer, null, null));
