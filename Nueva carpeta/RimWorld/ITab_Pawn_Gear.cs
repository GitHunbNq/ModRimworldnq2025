...
public class ITab_Pawn_Gear : ITab
{
	...
	protected override void FillTab()
	{
		...
		if (Prefs.DevMode && Widgets.ButtonText(new Rect(rect.xMax - 18f - 125f, 5f, 115f, Text.LineHeight), "Dev tool...", drawBackground: true, doMouseoverSound: true, active: true, null))
		{
