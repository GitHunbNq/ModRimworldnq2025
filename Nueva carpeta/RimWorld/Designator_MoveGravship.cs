...
public class Designator_MoveGravship : Designator
{
	...
	public override void DrawMouseAttachments()
	{
		if (!lastAcceptanceReport.Accepted)
		{
			...
			GenUI.DrawMouseAttachment(null, reason, 0f, default(Vector2), null, textColor, drawTextBackground: true, textBgColor, null);
		}
	}
	...
	public override void SelectedUpdate()
	{
		...
		GenDraw.DrawFieldEdges(tmpValidGravshipCells, ColorLibrary.White, null);
		GenDraw.DrawFieldEdges(tmpInvalidGravshipCells, ColorLibrary.Red, null);
		GenDraw.DrawDiagonalStripes(tmpValidGravshipCells, diagonalsColorValid, null);
		GenDraw.DrawDiagonalStripes(tmpInvalidGravshipCells, diagonalsColorInvalid, null);
		GenDraw.DrawFieldEdges(tmpThrusterCells, ColorLibrary.Orange, null);
