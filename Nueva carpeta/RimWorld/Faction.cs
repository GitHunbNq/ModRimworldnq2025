...
public class Faction : IExposable, ILoadReferenceable, ICommunicable
{
	...
	public void ExposeData()
	{
		...
		Scribe_Values.Look(ref allegianceColor, "mechColor", null);
	...
	public bool TryGenerateNewLeader()
	{
		...
		else if (def.pawnGroupMakers != null)
		{
			...
			if (list.TryRandomElement(out var result))
			{
				...
				PawnGenerationRequest request = new PawnGenerationRequest(kind, this, PawnGenerationContext.NonPlayer, null, leaderForceGenerateNewPawn, allowDead: false, allowDowned: false, canGeneratePawnRelations: true, mustBeCapableOfViolence: false, 1f, forceAddFreeWarmLayerIfNeeded: false, allowGay: true, allowPregnant: false, allowFood: true, allowAddictions: true, inhabitant: false, certainlyBeenInCryptosleep: false, forceRedressWorldPawnIfFormerColonist: false, worldPawnFactionDoesntMatter: false, 0f, 0f, null, 1f, null, null, null, null, null, null, null, null, null, null, null, null, forceNoIdeo: false, forceNoBackstory: false, forbidAnyTitle: false, forceDead: false, null, null, null, null, null, 0f, DevelopmentalStage.Adult, null, null, null);
