...
public class ComplexThreatWorker_FuelNode : ComplexThreatWorker
{
	...
	protected override bool CanResolveInt(ComplexResolveParams parms)
	{
		...
		{
			return ComplexUtility.TryFindRandomSpawnCell(ThingDefOf.AncientFuelNode, parms.room, parms.map, out spawnPosition, 1, null);
		}
		return false;
	}
	...
	{
		ComplexUtility.TryFindRandomSpawnCell(ThingDefOf.AncientFuelNode, parms.room, parms.map, out var spawnPosition, 1, null);
