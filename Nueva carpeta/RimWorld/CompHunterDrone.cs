...
public class CompHunterDrone : ThingComp
{
	...
	private void Detonate(Map map = null)
	{
		...
		GenExplosion.DoExplosion(position, map, Props.explosionRadius, Props.explosionDamageType, parent, Props.explosionDamageAmount, -1f, null, null, null, null, null, 0f, 1, null, null, 255, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, null, null);
