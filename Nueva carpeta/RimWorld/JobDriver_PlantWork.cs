				...
				if (plant.def.plant.harvestedThingDef != null)
				{
					...
					else
					{
						...
						if (num > 0)
						{
							...
							GenPlace.TryPlaceThing(thing, actor.Position, base.Map, ThingPlaceMode.Near, null, null, null);
						...
						if (plant.HarvestableNow)
						{
							foreach (ThingComp allComp in plant.AllComps)
							{
								foreach (ThingDefCountClass item in allComp.GetAdditionalHarvestYield())
								{
									...
									GenPlace.TryPlaceThing(thing2, actor.Position, base.Map, ThingPlaceMode.Near, null, null, null);
								}
							}
						}
					}
