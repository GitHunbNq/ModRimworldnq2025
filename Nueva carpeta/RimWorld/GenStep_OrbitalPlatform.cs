...
public class GenStep_OrbitalPlatform : GenStep
{
	...
	private void DoLargePlatforms(Map map, CellRect rect)
	{
		...
		for (int i = 0; i < randomInRange; i++)
		{
			...
			list.Remove(rot);
			SpaceGenUtility.GenerateConnectedPlatform(map, platformTerrain, rect, LargeLandingAreaWidthRange, LargeLandingAreaHeightRange, rot, 14, 0.2f, 2, null, null, null, null);
		}
	}
	...
	private void DoSmallPlatforms(Map map, CellRect rect)
	{
		...
		for (int i = 0; i < randomInRange; i++)
		{
			...
			SpaceGenUtility.GenerateConnectedPlatform(map, platformTerrain, platformRect, SmallPlatformSizeRange, SmallPlatformSizeRange, dir, SmallPlatformDistanceRange.RandomInRange, 0.2f, 2, null, null, null, null);
		}
	}
